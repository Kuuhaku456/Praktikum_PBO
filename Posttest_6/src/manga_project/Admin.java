...
public class Admin extends Akun implements admininterface {
    ...
    public void create() throws IOException{
        ...
        System.out.println("=================");
        System.out.print("Ingin menambah berapa data >> ");int batas = error_int();
    ...
    public void read(){
        if(this.Manga.isEmpty()){
            ...
            for(Manga m : this.Manga){
                System.out.printf("|%-7s  ", m.getID());
                System.out.printf("|\t%-20s   ", m.getJudul());
                System.out.printf("|\t%-18s    ", m.getGenre());
                System.out.printf("|\t%-22s   ", m.getTahun_rilis());
                System.out.printf("|\t%-13s   ", m.getPenulis());
                System.out.printf("|\t%-21s   |", m.getChapter());
                System.out.println("\n");
            }
            System.out.println("=========================================================================================================================================================");
        }
